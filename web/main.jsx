...
function Header() {
    return (
        <header className="fixed inset-x-0 top-0 bg-zinc-950 border-b-2 border-b-zinc-800">
            <Container>
                <div className="flex items-center justify-between">
                    <div className="flex items-center justify-start gap-2 py-3">
                        <AppLogo className="size-12" />
                        <h1 className="text-xl group relative">
                            <span className="text-blue-400 absolute text-xs -top-2">
                                React
                            </span>
                            Hooks Kit
                        </h1>
